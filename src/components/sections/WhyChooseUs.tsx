...
const FeatureCard: React.FC<{ item: Feature; index: number }> = ({ item, index }) => {
  ...
  return (
    <div ref={ref} className="flex flex-col text-left">
      ...
      {/* HEADING */}
      <motion.h3
        className="subtitle text-left mt-8 sm:mt-9 md:mt-15 mb-4 sm:mb-5 md:mb-9"
...
const WhyChooseUs: React.FC = () => {
  return (
    <section
      id="why-us"
      className="pt-15 sm:pt-16 md:pt-18 lg:pt-24 pb-14 sm:pb-20 md:pb-26 lg:pb-30 bg-bg text-text border-b border-text"
    >
      <Container>
        {/* SECTION TITLE */}
        <motion.h2
          className="text-center mb-8 sm:mb-12 md:mb-18 lg:mb-24"
